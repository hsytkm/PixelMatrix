...
namespace PixelMatrixLibrary.Wpf.Extensions
{
    public static class PixelMatrixExtension
    {
        ...
        public static void CopyToWriteableBitmap(in this PixelMatrix pixel, System.Windows.Media.Imaging.WriteableBitmap writeableBitmap)
        {
        ...
        public static System.Windows.Media.Imaging.WriteableBitmap ToWriteableBitmap(in this PixelMatrix pixel)
        {
            if (pixel.IsInvalid) throw new ArgumentException("Invalid ImagePixels");
            if (pixel.BytesPerPixel != 3) throw new NotSupportedException("Invalid BytesPerPixel");
            ...
            CopyToWriteableBitmap(pixel, writeableBitmap);
